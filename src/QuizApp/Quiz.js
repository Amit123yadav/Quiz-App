...
import { Stack, Button, Typography,FormControl,FormControlLabel, Radio } from '@mui/material'
import Result from './Result'
import { useSelector,useDispatch } from 'react-redux'
import {incrementQuestionIndex,appliedColor,appliedScore,negScore, updateColor, DisabledButton, DisabledButtonFalse, SetTimer, updateTime, emptyQues} from './Action/action'
// const initialValue = {
...
// ];
const Quiz = ({ retry }) => {
    const QuestionIndex =  useSelector((state) => state.increment.currentQuestionIndex)
        ...
        >
            ...
            >
                <Stack sx={{marginTop: '4rem'}}>
                    {isQuestionEnd ? (<Result retry={retry} score={applyScore} />  ) :
                        (<>
                                    ...
                                    <Stack >
                                        ...
                                        <Stack sx={{ marginLeft: '1rem',marginTop: '1rem'}}>
                                            <Typography variant='h4'>
                                                {queAr[QuestionIndex].id} {queAr[QuestionIndex].question}
                                            </Typography>
                                        </Stack>
                                        <>
                                                        ...
                                                        <FormControl>
                                                            ...
                                                            <Stack
                                                                ...
                                                                <FormControlLabel control={<Radio />}
                                                                    ...
                                                                    onClick={() => clickHandler(queAr[QuestionIndex].id, items.text)}
                                                                    name={items.text}
                                                                />
                                                                <label
                                                                    style={{ color: applyColor ? items.isCorrect ? applyColor : 'red' : '' }}
                                        ...
                                        <Stack >
                                            ...
                                            <Stack direction='row' sx={{
                                                ...
                                                >
                                                    ...
                                                    >{QuestionIndex === 4 ? 'End'   : 'Next'}</Button>
